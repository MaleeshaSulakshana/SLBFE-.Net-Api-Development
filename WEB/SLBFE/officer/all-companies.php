                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
                        <div class="section-heading">
                            <h2 class="sec__title">Companies</h2>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="billing-form-item">
                            <div class="billing-title-wrap">
                                <h3 class="widget-title pb-0">Companies</h3>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><button class="theme-btn border-0" 
                                                            onclick="view('<?php echo $value['companyId']; ?>')">View</button></td>
                                                </tr>
...
<script>
    function view($id) {
        document.location.href = 'view-company-details.php?id='+$id;
    }
</script>
