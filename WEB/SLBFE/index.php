                    ...
                    <div class="hero-content-wrapper">
                        <div class="hero-heading">
                            <div class="section-heading">
                                <h2 class="sec__title line-height-65">Explore Thousands of jobs Around You, Create a
                                    Free User Account</h2>
                        ...
                        <div class="btn-box margin-top-35px">
                            <a href="job-listing.php" class="theme-btn mr-2">Find a Job</a>
                            <a href="employer-dashboard-post-job.php" class="theme-btn bg-3">Post a Job</a>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="client-logo-wrap d-flex flex-wrap justify-content-center align-items-center">
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-2.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-3.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-4.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-5.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-6.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-7.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-8.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-9.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-10.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-11.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item">
                            <img src="asserts/images/client-logo-3.png" class="img-fluid" alt="brand-image">
                        </div><!-- end client-logo-item -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="btn-box margin-top-30px">
                        <a href="contact.php" class="theme-btn">Join with Us</a>
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
                    <div class="counter-content-wrap">
                        <div class="counter-item counter-item-layout-2 counter-item--layout-1">
                            <div class="counter-number">
                                <span data-purecounter-duration="2.5" data-purecounter-end="200"
                                    class="counter counter-color-1 purecounter">0</span>
                        ...
                        <div class="counter-item counter-item-layout-2 counter-item--layout-2">
                            <div class="counter-number">
                                <span data-purecounter-duration="2.5" data-purecounter-end="80"
                                    class="counter counter-color-2 purecounter">0</span>
                        ...
                        <div class="counter-item counter-item-layout-2 counter-item--layout-3">
                            <div class="counter-number">
                                <span data-purecounter-duration="2.5" data-purecounter-end="60"
                                    class="counter counter-color-3 purecounter">0</span>
                                <span class="counter__text">K</span>
                            </div><!-- end counter-number -->
                            <div class="counter-content mt-1">
                        ...
                        <div class="counter-item counter-item-layout-2 counter-item--layout-4">
                            <div class="counter-number">
                                <span data-purecounter-duration="2.5" data-purecounter-end="20"
                                    class="counter counter-color-4 purecounter">0</span>
                                <span class="counter__text">K</span>
                            </div><!-- end counter-number -->
                            <div class="counter-content mt-1">
...
================================= -->
    <section class="card-area section-bg padding-top-100px padding-bottom-110px">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-12">
                    <div class="tab-shared tab-shared-2">
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link theme-btn active" id="all-tab" data-toggle="tab" href="#all-job"
                                    role="tab" aria-controls="all-job" aria-selected="true">
                                    All Jobs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link theme-btn" id="recent-tab" data-toggle="tab" href="#recent-job"
                                    role="tab" aria-controls="recent-job" aria-selected="false">
                                    Recent Jobs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link theme-btn" id="full-time-tab" data-toggle="tab" href="#full-time-job"
                                    role="tab" aria-controls="full-time-job" aria-selected="false">
                                    Full Time Jobs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link theme-btn" id="part-time-tab" data-toggle="tab" href="#part-time-job"
                                    role="tab" aria-controls="part-time-job" aria-selected="false">
                                    Part Time Jobs
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="tab-content margin-top-35px" id="myTabContent">
                        <div class="tab-pane fade show active" id="all-job" role="tabpanel" aria-labelledby="all-tab">
                            <div class="row">
                                        ...
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_1"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                            xml:space="preserve">
                                                            <circle style="fill:#423966;" cx="256" cy="255.997"
                                                                r="255.997" />
    ...
    c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                            <g>
                                                                <rect x="172.853" y="117.47" style="fill:#A48DFF;"
                                                                    width="27.719" height="27.719" />
                                                                ...
                                                                L311.404,311.377z" />
                                                                <rect x="311.438" y="145.199" style="fill:#A48DFF;"
                                                                    width="27.719" height="27.719" />
                                                                <rect x="311.438" y="255.937" style="fill:#A48DFF;"
                                                                    width="27.719" height="27.719" />
                                                                <rect x="366.876" y="255.937" style="fill:#A48DFF;"
                                                                    width="27.719" height="27.719" />
                                                                <rect x="366.876" y="200.549" style="fill:#A48DFF;"
                                                                    width="27.719" height="27.719" />
                                                            </g>
                                                        </svg>
                                                    </a>
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">BlueTech</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">Graphic
                                                        Designer</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span class="color-text-2 font-size-13"><i class="la la-briefcase"></i>
                                                    Full Time</span>
                                                <span class="color-text-2 font-size-13"><i class="la la-clock-o"></i> 3
                                                    hours ago</span>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_2"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                                            <circle style="fill:#59480C;" cx="256.003" cy="256.003"
                                                                r="256.003" />
                                                            <path style="fill:#382D08;"
                                                                d="M367.906,206.302c-2.807,1.784-5.794,4.539-8.959,8.257l-9.814-9.814h-40.662v3.953l-48.827-48.827
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">MuffinTech</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">Executive, HR
                                                        Operations</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            <div class="section-block-2"></div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_3"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                                            <circle style="fill:#4F0A0A;" cx="256.003" cy="256.003"
                                                                r="256.003" />
                                                            <path style="fill:#260505;"
                                                                d="M245.901,114.471c0,0-25.629-4.553-25.966,30.35c-0.337,34.903,17.199,68.625,17.199,68.625
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">GoodLayer</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">Art Production
                                                        Specialist</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            <div class="section-block-2"></div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_4"
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">ThemeGood</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">Finance Manager &
                                                        Health</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            <div class="section-block-2"></div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_5"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">TechyDevs</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">ACB Product Sales
                                                        Specialist</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            <div class="section-block-2"></div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_6"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                                            <circle style="fill:#2A2B46;" cx="256.003" cy="256.003"
                                                                r="256.003" />
                                                            <path style="fill:#1C1C2E;"
                                                                d="M378.109,185.822l-2.539,3.533l-54.687-54.687c-3.281-4.153-6.851-8.18-10.746-12.076
                                                            ...
                                                            <g>
                                                                <path style="fill:#CBE8F2;"
                                                                    d="M304.576,128.17c11.874,11.874,21.195,25.699,27.705,41.09c6.738,15.932,10.156,32.86,10.156,50.314
                                                                ...
                                                                <rect x="288.743" y="184.295"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 417.2786 548.3727)"
                                                                    style="fill:#CBE8F2;" width="66.937"
                                                                    height="6.941" />

                                                                <rect x="246.499" y="199.47"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 374.1807 560.8715)"
                                                                    style="fill:#CBE8F2;" width="113.503"
                                                                    height="6.941" />

                                                                <rect x="219.868" y="218.313"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 334.7657 582.2308)"
                                                                    style="fill:#CBE8F2;" width="136.198"
                                                                    height="6.941" />

                                                                <rect x="195.01" y="234.925"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 293.1472 598.2161)"
                                                                    style="fill:#CBE8F2;" width="150.917"
                                                                    height="6.941" />

                                                                <rect x="179.778" y="253.625"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 253.569 619.2219)"
                                                                    style="fill:#CBE8F2;" width="150.503"
                                                                    height="6.941" />

                                                                <rect x="167.7" y="271.864"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 213.5818 639.1373)"
                                                                    style="fill:#CBE8F2;" width="142.922"
                                                                    height="6.941" />

                                                                <rect x="156.21" y="288.454"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 171.9116 655.0569)"
                                                                    style="fill:#CBE8F2;" width="130.825"
                                                                    height="6.941" />

                                                                <rect x="136.107" y="299.903"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 125.1135 658.5698)"
                                                                    style="fill:#CBE8F2;" width="125.689"
                                                                    height="6.941" />

                                                                <rect x="156.433" y="324.796"
                                                                    transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 91.7369 694.5314)"
                                                                    style="fill:#CBE8F2;" width="66.556"
                                                                    height="6.941" />
                                                            </g>
                                                            <g>
                                                                <path style="fill:#00C6FD;"
                                                                    d="M204.411,390.563c-1.11-1.11-2.211-2.251-3.272-3.388l9.685-9.029
                                                                ...
                                                                <path style="fill:#00C6FD;"
                                                                    d="M178.273,295.243c0-32.397,12.616-62.854,35.524-85.762s53.365-35.524,85.762-35.524
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a href="employer-details.php">Penske
                                                            Media</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            ...
                                            <div class="card-content mt-4 margin-bottom-30px">
                                                <h4 class="card-title mb-2"><a href="job-details.php">Senior Web
                                                        Designer</a> </h4>
                                                <p class="card-sub"></p>
                                            </div>
                                            <div class="section-block-2"></div>
                        ...
                        <div class="tab-pane fade" id="recent-job" role="tabpanel" aria-labelledby="recent-tab">
                            <div class="row">
                                <div class="col-lg-4 responsive-column">
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_7"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">TechyNectar</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_8"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">RevoTheme</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_9"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">Unbold</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_10"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                            xml:space="preserve">
    ...
    c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">ThemePress</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_11"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">PixelSort</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker">Aberdeen, United
                                                            Kingdom</i> </p>
                                                </div>
                                            </div>
                                            <div class="card-content mt-4 margin-bottom-30px">
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_12"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                                ...
                                                <div class="company-title-box">
                                                    <h4 class="card-title mb-1"><a
                                                            href="employer-details.php">DesingLayer</a> </h4>
                                                    <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen,
                                                        United Kingdom</p>
                                                </div>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="full-time-job" role="tabpanel" aria-labelledby="full-time-tab">
                            <div class="row">
                                <div class="col-lg-4 responsive-column">
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_13"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_14"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                            xml:space="preserve">
    ...
    c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z" />
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_15"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_16"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_17"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_18"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                        ...
                        <div class="tab-pane fade" id="part-time-job" role="tabpanel" aria-labelledby="part-time-tab">
                            <div class="row">
                                <div class="col-lg-4 responsive-column">
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_19"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                                            xml:space="preserve">
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_20"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_21"
                                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
                                                            xml:space="preserve">
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_22"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_23"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512 512"
                                                            style="enable-background:new 0 0 512 512;"
                                    ...
                                    <div class="job-card">
                                        <div class="job-card-content">
                                            <div class="card-head d-flex align-items-center">
                                                <div class="company-avatar mr-3">
                                                    <a href="employer-details.php" class="d-block">
                                                        <svg class="card-svg" version="1.1" id="Capa_24"
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 512.007 512.007"
                                                            style="enable-background:new 0 0 512.007 512.007;"
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="btn-box text-center mt-4">
                        <a href="job-listing.php" class="theme-btn">View all Jobs</a>
                    </div>
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
        </div><!-- end container -->
    ...
    <section class="hiw-area text-center padding-top-100px padding-bottom-80px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="sec__title">How We Works for You?</h2>
                        <p class="sec__desc">
